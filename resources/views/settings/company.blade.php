                            ...
                            <form>
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <textarea type="textarea" class="form-control" id="name" name="about"placeholder="{{ $company->about }}"
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <textarea type="textarea" class="form-control" id="name" name="mission"placeholder="{{ $company->mission }}"
                                            value="{{ $company->mission }}"></textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <textarea type="textarea" class="form-control" id="name" name="contact_address"placeholder="{{ $company->contact_address }}"
                                            value="{{ $company->contact_address }}"></textarea>
                                    </div>
                                    <div class="col-sm-4">

											...
											<div class="modal-content">
                                                ...
                                                <form action="{{ route('payment.edit',$payment->id) }}" method="post">
														...
														<div class="form-group">
															<label for="recipient-name" class="col-form-label">الرصيد المدفوع - يتم تعديل قيمة الرصيد المتبقي بشكل تلقائي </label>
															<input type="number" name="paid" class="form-control" id="recipient-name">
														</div>

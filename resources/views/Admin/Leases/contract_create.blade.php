            ...
            <form action="{{ route('rent_contract_store') }}" method="post"
                ...
                <div class="form-group">
                    ...
                    <div class="grid">
                        <div class="col-1-4">
                            <div class="controls">
                                ...
                                <input type="text" value="" name="quarter"
                    ...
                    <div class="grid">
                        ...
                        <div class="col-1-4">
                            <div class="controls">
                                <input type="number" id="shopsNo" class="floatLabel"
                                    value="{{ old('shopsNo') }}"name="shopsNo"required>
                    ...
                    <div class="grid">
                        ...
                        <div class="col-1-4">
                            <div class="controls">
                                <input type="text" class="floatLabel"name="size"value="{{ old('size') }}"
                                    placeholder=""required>

...
<div class="form-group">
      ...
      <div class="grid">
        <div class="col-1-2">
          ...
          <input type="hidden" id="name"value="{{$contract->id}}"name="contract_id">
           <input type="text" id="name" class="floatLabel" value="{{$owner->name}}"name="name">
           <label for="street">الاسم</label>
          </div>
        </div>
         <div class="col-1-2">
          <div class="controls">
            <input type="text" id="mobile" class="floatLabel" value="{{$owner->mobile}}"name="mobile"required>
        ...
        <div class="col-1-2">
          <div class="controls">
           <input type="email" id="email" class="floatLabel" value="{{$owner->email}}"name="email"required>
           <label for="street">البريد</label>
          </div>
        </div>
         <div class="col-1-2">
          <div class="controls">
            <input type="text" id="attribute_name" class="floatLabel" value="{{$owner->attribute_name}}"name="attribute_name">
  ...
  <h2 class="heading">بيانات العقد</h2>
   <div class="grid">
        <div class="col-1-3">
          <div class="controls">
           <input type="text" id="contactNo" class="floatLabel" value="{{$contract->contactNo}}"name="contactNo"required>
           <label for="street">رقم سجل العقد - ID</label>
          </div>
        </div>
         <div class="col-1-3">
         <div class="controls">
           <input type="text" id="ejar_cost" class="floatLabel" value="{{$contract->ejar_cost}}"name="ejar_cost"required>
           <label for="street"> كلفة  الاستئجار</label>
          </div>
        </div>
        <div class="col-1-3">
             <div class="controls">
           <input type="number" id="ensollments_total" class="floatLabel" value="{{$contract->ensollments_total}}"name="ensollments_total"required>
 ...
 <div class="grid">
        <div class="col-1-2">
            <div class="controls">
            <input type="date" id="start_date" class="floatLabel" value="{{$contract->start_date}}"name="start_date"required>
         ...
         <div class="col-1-2">
            <div class="controls">
            <input type="date" id="end_date" class="floatLabel" value="{{$contract->end_date}}"name="end_date"required>
...
<div class="grid">
        <div class="col-1-3">
         ...
         <div class="col-1-3">
          <div class="controls">
            <input type="text" id="tax_amount" class="floatLabel" value="{{$contract->tax_amount}}"name="tax_amount"required>
            <label for="phone">مبلغ الضريبة</label>
          </div>
        </div>
         <div class="col-1-3">
          <div class="controls">
            <input type="text" id="rent_value" class="floatLabel" value="{{$contract->rent_value}}"name="rent_value"required>
...
<div class="grid">
        ...
        <div class="col-2-3">
          <div class="controls">
            <input type="text" id="note" class="floatLabel" value="{{$contract->note}}"name="note">
      ...
      <div class="grid">
        <div class="col-1-4">
          <div class="controls">
           ...
           <input type="text" value="{{ $contract->quarter }}" name="quarter" class="floatLabel"placeholder=""required>
           <label for="street">الحي</label>
          </div>
        </div>
         <div class="col-1-4">
          <div class="controls">
            <input type="text" id="realty_name" class="floatLabel"value="{{$contract->realty_name}}"name="realty_name" placeholder=""required>
            <label for="eMail">اسم المنشأة</label>
          </div>
        </div>
         <div class="col-1-4">
          <div class="controls">
            <input type="text" class="floatLabel"name="agency_name" value="{{$contract->agency_name}}"placeholder="">
            <label for="eMail">اسم الوكيل</label>
          </div>
        </div>
        <div class="col-1-4">
          <div class="controls">
            <input type="text" class="floatLabel"name="agency_mobile"value="{{$contract->agency_mobile}}" placeholder="">
        ...
        <div class="col-1-4">
          <div class="controls">
           <select name="use" id="use" class="floatLabel" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                        <option value="family" {{($contract->use) == 'family' ? 'selected' : '' }}> عائلي</option>
                                        <option value="individually"{{($contract->use) == 'individually' ? 'selected' : '' }}> افراد</option>
                                </select>
 ...
 <div class="col-1-4">
         ...
         <div class="col-1-4">
          <div class="controls">
           <input type="number" id="units" class="floatLabel" value="{{$contract->units}}"name="units"required>
           <label for="street">عدد الوحدات السكنية</label>
          </div>
        </div>
         <div class="col-1-4">
          <div class="controls">
           <input type="number" id="shopsNo" class="floatLabel"value="{{$contract->shopsNo}}"name="shopsNo"required>
   ...
   <div class="grid">
         ...
         <div class="col-1-4">
          <div class="controls">
            <input type="number" class="floatLabel"name="roles" value="{{$contract->roles}}"placeholder=""required>
            <label for="eMail">عدد الأدوار</label>
          </div>
        </div>
        <div class="col-1-4">
          <div class="controls">
            <input type="text" class="floatLabel"name="size"value="{{$contract->size}}" placeholder=""required>
         ...
         <div class="col-1-4">
          <div class="controls">
            <select name="elevator"value="{{old('elevator')}}" id="type" class="floatLabel" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="yes"{{($contract->elevator) == 'yes' ? 'selected' : '' }}> نعم</option>
                                    <option value="no"{{($contract->elevator) == 'no' ? 'selected' : '' }}>لا</option>
                                </select>
         ...
         <div class="col-1-4">
          <div class="controls">
            <select name="parking"value="{{old('parking')}}" id="type" class="floatLabel" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option value="yes"{{($contract->parking) == 'yes' ? 'selected' : '' }}> نعم</option>
                                    <option value="no"{{($contract->parking) == 'yes' ? 'selected' : '' }}>لا</option>
                                </select>
...
<div class="grid">
   <div class="col-2-3">
          <div class="controls">
            <input type="text" width="100px"height="100px"id="st_rental_date" class="floatLabel" value="{{$contract->advantages}}"name="advantages" placeholder="">
         ...
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
                                ...
                                @forelse ($ensollments as $ensollment)
                                        ...
                                        <tr>
                                            <td><input class="form-control" type="number"value="{{ $ensollment->installmentNo }}" id="installmentNo" name="installmentNo[]"required></td>
                                            <td><input class="form-control" type="date" id="installment_date"value="{{ $ensollment->installment_date }}" name="installment_date[]"required></td>
                                            <td><input class="form-control unit_price"  type="number" id="refrenceNo" value="{{ $ensollment->refrenceNo }}"name="refrenceNo[]"readonly></td>
                                            <td><input class="form-control unit_price"  type="date" id="payment_date" value="{{ $ensollment->payment_date }}"name="payment_date[]"required></td>
                                            <td><input class="form-control unit_price"  type="number" id="amount"value="{{ $ensollment->amount }}" name="amount[]"required></td>
                                           <td><input class="form-control unit_price"  type="text" id="payment_type"value="{{ $ensollment->payment_type }}" name="payment_type[]"required></td>
                                        </tr>
                                        @empty
                                        @endforelse
                                        </tbody>
...
<div class="mb-3">
  <input class="form-control" name="contract_file"accept=".pdf,.jpg, .png, image/jpeg, image/png"type="file" id="formFileDisabled">
</div>

                    ...
                    <div class="card-body p-0">
                        <div class="invoice-container">
                            <div class="invoice-header">
                                <div class="modal" id="add_payment{{ $lease->id }}" tabindex="-1" role="dialog"
                                                ...
                                                <form action="{{ route('payment_lease_add', $lease->id) }}" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label class="active" for="recipient-name"
                                                            class="col-form-label">تاريخ الاصدار</label>
                                                        <input type="date" name="release_date" class="form-control"
                                                            id="recipient-name"required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="active" for="recipient-name"
                                                            class="col-form-label">تاريخ الاستحقاق</label>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <div class="custom-actions-btns mb-5">
                                            <a data-toggle="modal" href=""
                                                data-target="#add_payment{{ $lease->id }}"href="#"

...
<form action="{{ route('lease_update') }}" method="post" enctype="multipart/form-data"autocomplete="off">
  ...
  <div class="form-group">
    <h2 class="heading">بيانات العقد</h2>
      <div class="grid">
        <div class="col-1-2">
          <div class="controls">
           ...
           <input type="text" id="reco_number" class="floatLabel" value="{{ $lease->reco_number }}"name="reco_number"required>
           <label for="street">رقم سجل العقد - ID</label>
          </div>
        </div>
        <div class="col-1-2">
          <div class="controls">
           <input type="text" id="place" class="floatLabel" value="{{ $lease->place }}"name="place"required>
      ...
      <div class="col-1-3">
          <div class="controls">
            <input type="date" id="le_date" class="floatLabel"value="{{ $lease->le_date }}" name="le_date"required>
        ...
        <div class="col-1-3">
          ...
          <div class="controls">
            <input type="date" id="st_rental_date" class="floatLabel" value="{{ $lease->st_rental_date }}"name="st_rental_date"required>
        ...
        <div class="col-1-3">
          <div class="controls">
            <input type="date" id="end_rental_date" class="floatLabel" value="{{ $lease->end_rental_date }}"name="end_rental_date"required>
  ...
  <div class="form-group">
    <h2 class="heading">بيانات المستأجر</h2>
      <div class="grid">
        <div class="col-1-4">
          <div class="controls">
           ...
           <input type="text" name="t_name" value="{{$tenant->user->name}}"class="floatLabel"required>
        ...
        <div class="col-1-4">
          <div class="controls">
           <input type="text" name="t_ID_num"value="{{$tenant->user->ID_num}}"class="floatLabel"required>
      ...
      <div class="grid">
        ...
        <div class="col-1-4">
          <div class="controls">
           <input type="email"  name="t_email" value="{{$tenant->user->email}}"class="floatLabel"required>
           <label for="eMail"> البريد الالكتروني</label>
          </div>
        </div>
        <div class="col-1-4">
          <div class="controls">
           <input type="text" name="t_phone" value="{{$tenant->user->phone}}"class="floatLabel"required>
        ...
        <div class="col-1-4">
          <div class="controls">
             @error('t_telephone')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
           <input type="text" name="t_telephone" value="{{$tenant->user->telephone}}"class="floatLabel">
...
<div class="grid">
         <div class="col-1-3">
          <div class="controls">
           <input type="text" name="ejar_cost" class="floatLabel"value="{{$lease->financial->ejar_cost}}"required>
      ...
      <div class="col-1-3">
        ...
        <div class="col-1-3">
          <div class="controls">
           <input type="text" name="num_rental_payments" value="{{$lease->financial->num_rental_payments}}"class="floatLabel"required>
  ...
  <div class="col-1-2">
          <div class="controls">
           <input type="text" name="recurring_rent_payment" value="{{$lease->financial->recurring_rent_payment}}"class="floatLabel"required>
      ...
      <div class="grid">
       <div class="col-2-3">
          <div class="controls">
           <input type="text" name="notes" value="{{$lease->financial->notes}}"class="floatLabel">
      ...
      @if($unit->type=="محل تجاري")
        ...
        <div class="col-1-3">
          <div class="controls">
           <input type="text" name="tax_ammount" class="floatLabel"value="{{$lease->financial->tax_ammount}}"required>
           <label for="eMail">مبلغ الضريبة</label>
          </div>
        </div>
         <div class="col-1-3">
          <div class="controls">
           <input type="text" name="rent_value" class="floatLabel"value="{{$lease->financial->rent_value}}"required>
							...
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">
                                        ...
                                        <tr>
                                            <td><input class="form-control" value="{{$payment->release_date}}"type="date" id="release_date" name="release_date[]"readonly></td>
                                            <td><input class="form-control" value="{{$payment->due_date}}"type="date" id="due_date" name="due_date[]"required></td>
                                            <td><input class="form-control unit_price" value="{{$payment->total}}" type="text" id="total" name="total[]"required></td>
                                        </tr>
                                        @empty
                                        @endforelse
                                        </tbody>
...
<div class="mb-3">
  <input class="form-control" name="docFile"accept=".pdf,.jpg, .png, image/jpeg, image/png"type="file" id="formFileDisabled">
</div>

                        ...
                        <div class="col-1-2">
                            <div class="controls">
                                ...
                                <input type="text" id="reco_number" class="floatLabel"
                                    value="{{ $lease->reco_number }}"name="reco_number"required>
                        ...
                        <div class="col-1-2">
                            <div class="controls">
                                <input type="text" id="place" class="floatLabel"
                                    value="{{ $lease->place }}"name="place"required>
                        ...
                        <div class="col-1-3">
                            <div class="controls">
                                <input type="date" id="end_rental_date" class="floatLabel"
                                    value="{{ $lease->end_rental_date }}"name="end_rental_date"required>
                                            ...
                                            @forelse ($payments as $payment)
                                                <tr>
                                                    <td><input class="form-control"
                                                            value="{{ $payment->release_date }}"type="date"
                                                    ...
                                                    <td><input class="form-control unit_price"
                                                            value="{{ $payment->total }}" type="text" id="total"

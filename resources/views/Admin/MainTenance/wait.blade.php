                        ...
                        <tr>
                          ...
                          <td>{{$maint->request_date}}</td>
                           <td><span class="badge badge-danger"> <a
                                                    data-toggle="modal" href="" data-target="#edit_payment{{ $maint->id }}"> Add</a></td>
												</tr>
                                                <div class="modal" id="edit_payment{{$maint->id}}" tabindex="-1" role="dialog" aria-labelledby="customModalTwoLabel" aria-hidden="true">

        ...
        <div class="row gutters">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <form action="{{ route('realties.store') }}" method="post"
                            ...
                            <div class="row gutters">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"value="{{ old('quarter') }}"
                                            name="quarter" placeholder="quarter"required>
                                    </div>
                                    <div class="form-group">
                                        <label class="active" for="phone"> عدد الوحدات</label>
                                        <input type="number" class="form-control" value="{{ old('units') }}"name="units"
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('realty_name') }}"name="realty_name"
                                            placeholder="realty_name"required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="roles"
                                            value="{{ old('roles') }}"placeholder="roles"required>
                                    </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="use" id="use" class="form-control SlectBox"
                                            onclick="console.log($(this).val())"
                                            onchange="console.log('change is firing')"required>
                                            <!--placeholder-->
                                            <option value="" selected disabled>حدد النوع</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('advantages') }}"name="advantages"
                                            placeholder="advantages"required>
                                    </div>

                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" value="{{ $realty->type }}"id="type"
                                                ...
                                                onchange="console.log('change is firing')"required>
                                                <!--value-->
                                                <option value="building"{{ $realty->type == 'building' ? 'selected' : '' }}>
                                                    بناء</option>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="use" value="{{ $realty->use }}"id="use"
                                                ...
                                                onchange="console.log('change is firing')"required>
                                                <!--value-->
                                                <option value="family" {{ $realty->use == 'family' ? 'selected' : '' }}>
                                                    عائلي</option>
                                                <option value="individually"
                                                    {{ $realty->use == 'individually' ? 'selected' : '' }}> افراد</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="agency_mobile"

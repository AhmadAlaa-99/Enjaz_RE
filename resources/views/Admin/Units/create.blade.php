                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control" name="size"value="{{ old('size') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="textarea" class="form-control" id="details" name="details"value="{{ old('details') }}"
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-right">
                                        ...
                                        <button type="submit" name="submit" name="submit" class="btn btn-dark">حفظ

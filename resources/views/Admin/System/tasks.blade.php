                            ...
                            <div class="tasks-container">
                                        ...
                                        <div class="modal-content">
                                                ...
                                                <form class="row gutters">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            <label class="active" for="taskTitle">Task Title</label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="custom-date-input">
                                                                <input type="text" name=""
                                                                    ...
                                                                    placeholder="10/11/2019">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group mb-0">
                                                            <label class="active" for="addResss">Task Details</label>
                                            ...
                                            <div class="modal-footer custom">
                                                ...
                                                <div class="right-side">
                                                    <button type="button"
                                                        class="btn btn-link success btn-block">Create</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tasks-header">
                                    ...
                                    <button class="btn btn-primary btn-lg" data-toggle="modal"
                                        data-target="#addNewTask">Add New Task</button>
                                </div>
                                            ...
                                            <section class="task-list">
                                                ...
                                                <div class="task-block">
                                                    ...
                                                    <div class="task-details">
                                                        ...
                                                        <div class="task-desc">Incentivize, incentivize convergence
                                                            weblogs, schemas sticky plug-and-play. Customized markets,
                                                            sticky one-to-one exploit.</div>
                                                    ...
                                                    <ul class="task-actions">
                                                        ...
                                                        <li>
                                                            <a href="#" class="star" data-toggle="tooltip"
                                                                data-placement="top" title="Star">
                                                                <i class="icon-stars"></i>
                                                            </a>
                                                        </li>
                                                        <li class="dropdown">
                                                            <a href="#" id="task-actions" data-toggle="dropdown"
                                                                aria-haspopup="true">

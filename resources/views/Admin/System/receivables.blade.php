...
<div class="page-header">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">الذمم المالية</li>
    </ol>
...
<label>البحث وفق الدفعات التي لم تسدد بشكل</label>
							...
							<div class="card">
                                ...
                                @forelse ($receivables as $receivable)
                                    ...
                                    @endphp
												    <tr>
													<td>{{$i}}</td>
                                                    <td>{{$receivable->reco_number}}</td>
													<td>{{$receivable->release_date}}</td>
													<td>{{$receivable->due_date}}</td>
													<td>{{$receivable->total}}</td>
                                                    <td>{{$receivable->paid}}</td>
													<td>{{$receivable->remain}}</td>
                                                <td><span class="badge badge-danger"><a href="{{route('payment.details',$receivable->id)}}" > تفاصيل </a></td>
												</tr>
                                                @empty
                        @endforelse
                    </tbody>
